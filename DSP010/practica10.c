...
void Conf_maq()
{
 ...
 GPIO_Digital_Input(&GPIOC_BASE,_GPIO_PINMASK_13);    //Entrada con Pullup usando el botón de usuario (PC13)
  ...
  GPIO_Config(&GPIOC_BASE, _GPIO_PINMASK_0, _GPIO_CFG_MODE_INPUT | _GPIO_CFG_PULL_DOWN);  //boton en pull down                                                                              //(Entrada normalmente en bajo y el botón se desactiva en 3.3V)
...
void Conf_maq()
{
 ...
 GPIO_Config(&GPIOA_BASE, _GPIO_PINMASK_0, _GPIO_CFG_MODE_INPUT | _GPIO_CFG_PULL_DOWN);  //boton en pull down                                                                              //(Entrada normalmente en bajo y el botón se desactiva en 3.3V)
