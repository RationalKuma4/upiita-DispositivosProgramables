 ...
 * Return Type  : void
 */
void Lista_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *plhs
               [1])
{
  ...
  emxInit_real_T(&st, &vector, 2, true);
  ...
  plhs[0] = emlrt_marshallOut(vector);
  vector->canFreeData = false;
  emxFree_real_T(&st, &vector);
...
/*
 * File trailer for _coder_Lista_api.c
 *
 * [EOF]
 */
