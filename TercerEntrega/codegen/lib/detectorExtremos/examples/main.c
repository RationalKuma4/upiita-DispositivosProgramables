...
#include "main.h"
#include "detectorExtremos_terminate.h"
#include "detectorExtremos_initialize.h"

/* Function Declarations */
static void argInit_1x8000_real_T(double result[8000]);
static double argInit_real_T(void);
static void main_detectorExtremos(void);
...
static void main_detectorExtremos(void)
{
  ...
  /* Initialize function 'detectorExtremos' input arguments. */
  /* Initialize function input argument 'Y'. */
  /* Call the entry-point 'detectorExtremos'. */
  argInit_1x8000_real_T(dv0);
  detectorExtremos(dv0, palabradelimitada);
}
